...
public class App {
	...
	public static void main(String[] args) {	
		...
		DAO<Departamento> departamentoDAO = new DepartamentoDAO();
		log.debug("[main] departamentoDAO:"+departamentoDAO);
		try {

			log.debug("[main]Buscamos los departamento"); List<Departamento>
			departamentos =departamentoDAO.findAll();
			log.debug("[main]Mostramos todos los departamentos"); departamentos.forEach(d
